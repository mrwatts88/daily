...
and `group`, the name of the group a row belongs to), `the-list-groups` (`{name: {color}}`; rows in
a group share the color, stay contiguous, and move together by the colored outer handle),
